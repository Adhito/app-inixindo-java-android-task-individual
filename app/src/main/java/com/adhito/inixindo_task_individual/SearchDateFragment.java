    ...
    private void getJSONDate() {
        class GetJSON extends AsyncTask<Void, Void, String> {
            ...
            protected String doInBackground(Void... voids) {
                ...
                String result = handler.sendGetResponseDate(Konfigurasi.URL_SEARCH_DATE, start, end);
                Log.d("res:", result);
                Log.d("start:", start);
                Log.d("end:", end);
                return result;
            ...
            protected void onPostExecute(String s) {
                ...
                try {
                    ...
                    JSONArray jsonArray = jsonObject.getJSONArray(Konfigurasi.TAG_JSON_ARRAY_DATE);
                    ...
                    for (int i=0;i<jsonArray.length(); i++){
                        ...
                        String subject = object.getString(Konfigurasi.TAG_JSON_SUBJECTNAME_DATE);
                        String ins = object.getString(Konfigurasi.TAG_JSON_INSTRUCTORNAME_DATE);
                        String start = object.getString(Konfigurasi.TAG_JSON_CLASSSTART_DATE);
                        String end = object.getString(Konfigurasi.TAG_JSON_CLASSEND_DATE);

                        HashMap<String, String> classes = new HashMap<>();
                        classes.put(Konfigurasi.TAG_JSON_SUBJECTNAME_DATE, subject);
                        classes.put(Konfigurasi.TAG_JSON_INSTRUCTORNAME_DATE, ins);
                        classes.put(Konfigurasi.TAG_JSON_CLASSSTART_DATE, start);
                        classes.put(Konfigurasi.TAG_JSON_CLASSEND_DATE, end);
                ...
                ListAdapter adapter = new SimpleAdapter(
                        ...
                        new String[] {Konfigurasi.TAG_JSON_SUBJECTNAME_DATE, Konfigurasi.TAG_JSON_INSTRUCTORNAME_DATE, Konfigurasi.TAG_JSON_CLASSSTART_DATE, Konfigurasi.TAG_JSON_CLASSEND_DATE},
