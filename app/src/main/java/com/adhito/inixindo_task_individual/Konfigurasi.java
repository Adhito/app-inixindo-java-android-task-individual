...
public class Konfigurasi {
    ...
    // Web API untuk Kelas
    public static final String URL_KELAS_GET_ALL       = "http://192.168.5.83/api_task_individual/get_all_kelas.php";
    public static final String URL_KELAS_GET_DETAIL    = "http://192.168.5.83/api_task_individual/get_detail_kelas.php?id_kls=";
    public static final String URL_KELAS_ADD           = "http://192.168.5.83/api_task_individual/add_kelas.php";
    ...
    public static final String URL_KELAS_DETAIL_JUMLAH_GET_ALL      = "http://192.168.5.83/api_task_individual/get_all_detail_kelas_jumlah.php";
